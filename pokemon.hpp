...
public:
	...
	static constexpr uint64_t ABILITY_QUARKDRIVE      = 0x0008000000000000; // クォークチャージ
	static constexpr uint64_t ABILITY_ORICHALCUMPULSE = 0x0010000000000000; // ヒヒイロの鼓動
	static constexpr uint64_t ABILITY_HADRONENGINE    = 0x0020000000000000; // ハドロンエンジン
};
